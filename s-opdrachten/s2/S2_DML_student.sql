...
-- TABLE uitvoeringen
-- TABLE medewerkers
    INSERT INTO uitvoeringen(cursus,begindatum,docent,locatie) VALUES('S02','2022-03-02',(SELECT mnr FROM medewerkers WHERE voorl='N'AND naam='SMIT'),'IJsselstein') ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
...
INSERT INTO medewerkers(mnr,naam,voorl,functie,chef,gbdatum,maandsal,comm,afd) VALUES (8001,'GLANSDORP','H','STAGIAIR',7839,'2001-03-30',0,0,20)
...
-- table schalen
INSERT INTO schalen(snr, ondergrens, bovengrens, toelage)VALUES (6, 3001, 4000, 500) ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
...
INSERT INTO cursussen(code, omschrijving,"type",lengte) VALUES ('B&P','Omschrijving van Data & Persistency','ALG',6);
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]

INSERT INTO uitvoeringen(cursus,begindatum,docent,locatie) VALUES ('B&P','2022-03-02',7788,'Leerdam'),('B&P','2022-03-03',7788,'Leerdam')
    ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
INSERT INTO inschrijvingen(cursist,cursus,begindatum,evaluatie) VALUES(7902,'D&P','2022-04-02',2);
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]

INSERT INTO inschrijvingen(cursist,cursus,begindatum,evaluatie)VALUES(7788,'D&P','2022-05-02',2);
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]

INSERT INTO inschrijvingen(cursist,cursus,begindatum,evaluatie) VALUES(7698,'D&P','2022-05-02',3);
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
